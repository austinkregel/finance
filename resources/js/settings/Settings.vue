                    ...
                    <div class="router-link-table">
                        <ul class="flex flex-col" :class="{ 'text-white': $store.getters.darkMode, 'text-gray-600': !$store.getters.darkMode }">
                            ...
                            <li  class="flex items-center pt-4">
                                ...
                                <router-link to="/notifications" class="text-lg pl-4 font-bold">
                                    Notifications
                                </router-link>
                            </li>
                            <li  class="flex items-center pt-4">
                                <svg class="w-6" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10.496 2.132a1 1 0 00-.992 0l-7 4A1 1 0 003 8v7a1 1 0 100 2h14a1 1 0 100-2V8a1 1 0 00.496-1.868l-7-4zM6 9a1 1 0 00-1 1v3a1 1 0 102 0v-3a1 1 0 00-1-1zm3 1a1 1 0 012 0v3a1 1 0 11-2 0v-3zm5-1a1 1 0 00-1 1v3a1 1 0 102 0v-3a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                                <router-link to="/plaid" class="text-lg pl-4 font-bold">
                                    Plaid
                                </router-link>
                            </li>
                            <li  class="flex items-center pt-4">
                                ...
                                <router-link to="/historical-sync" class="text-lg pl-4 font-bold">
                                    Historical Sync
                                </router-link>
                            </li>
                            <li  class="flex items-center pt-4">
                            ...
                            <li  class="flex items-center pt-4">
                                <svg class="w-6" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                                <router-link to="/failed-jobs" class="text-lg pl-4 font-bold">
                                    Failed Jobs
                                </router-link>
                            </li>
                            <li class="flex items-center pt-4">
                            ...
                            <li class="flex items-center pt-2 text-red-500">
