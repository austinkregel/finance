                ...
                >
                    ...
                    <div class="flex justify-between items-center">
                        <div class="text-xs flex-grow tracking-wide">
                            <span v-if="transaction.bill_name">{{ transaction.bill_name.type }},</span>
        ...
        <modal ref="transactionModal" @closed="closeModal">
            <div v-if="transaction" class="relative">
                ...
                <div class="flex flex-wrap py-2" :class="{'border-t border-b': transaction.is_possible_subscription}">
                    ...
                    <div class="w-full text-base p-0 ">
    ...
    export default {
        ...
        methods: {
            ...
            getTransactions($state, extraFilters = {}) {
                ...
                axios.get(buildUrl('/api/transactions', {
                    page: this.page + '',
                    include: 'categories,bill_name,account',
                    filter: extraFilters,
                    sort: '-date',
                    action: 'paginate:30'
                }))
            ...
            nonRecurrent() {
                axios.put('/api/transactions/' + this.transaction.id, {
            ...
            saveTheLabel() {
                axios.put('/api/transactions/' + this.transaction.id, Object.assign({
                    is_possible_subscription: false,
